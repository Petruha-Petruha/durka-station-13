...
/datum/map/sierra/map_info(victim)
	...
	to_chat(victim, "Вы находитесь на борту <b>[station_name]</b>, клинического психоневрологического диспансера корпорации ШизоТрейзен. Основная миссия вашей клиники - содержание и лечение шизоидов.")
	to_chat(victim, "Охрана судна укомплектована Санитарами ШизоТрайзен и частных психологов.")
	to_chat(victim, "Помимо <small>шизоидов</small> в охране, в остальных отделах также присутствуют подрядчики. Их наняли как выдающихся специалистов в своей области, что превзошли корпоративного кандидата. Как правило, они либо работают на себя (civilian), либо на другую корпорацию (contractor). Полезные ссылки:")
...
/datum/map/sierra/send_welcome()
	...
	welcome_text += "Дней до планеты ШУЕ: <b>[rand(15,45)]</b><br />"
	welcome_text += "Дней с последнего визита в притон: <b>[rand(60,180)]</b><br />"
